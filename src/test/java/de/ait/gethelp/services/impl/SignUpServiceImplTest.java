...
class SignUpServiceImplTest {
    ...
    void signUp() {
        ...
        UserDto act = signUpService.signUp(newUserDto);
    ...
    void signUp_username_exist() {
        ...
        UserDto usernameAct = signUpService.signUp(newUserDto);
    ...
    @Test
    void signUp_username_lessThen3() {
    ...
    @Test
    void signUp_password_lessThen3() {
